...
// an array of arrays. One array for each row.
 var data1 = [
    ...
    ["Paige Eicher", "Javascript Developer", "San Francisco", "2760", "2011/09/16", "$230,500"],
    ["Sydney Neal","Accountant", "London", "5407", "2009/11/28", "$175,700"]
];
...
Function dataTable_onshow()
  modAlert.toggle()
  modAlert.value = ("We added Paige Eicher and Sydney Neal! </br> The data inputed is: Paige Eicher, Javascript Developer, San Francisco, 2760, 2011/09/16, $230,500 </br> Sydney Neal, Accountant, London, 5407, 2009/11/28, $175,700")
End Function